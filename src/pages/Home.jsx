          ...
          >
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div>
                    ...
                    <ScrollReveal direction="up" delay={0.3}>
                      <div className="w-16 h-px bg-gray-400 dark:bg-gray-600 mb-8"></div>
                    </ScrollReveal>
                    ...
                    <ScrollReveal direction="up" delay={0.5}>
                      <Link 
                        to="/about"
                        className="inline-block border border-black dark:border-white text-black dark:text-white px-8 py-3 rounded-full font-medium hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300"
              ...
              <section className="py-16 border-t border-gray-200 dark:border-gray-800">
                <div className="overflow-hidden">
                  <div className="flex animate-marquee-slow whitespace-nowrap">
                    <div className="flex items-center gap-8 text-2xl md:text-3xl lg:text-4xl font-bold text-gray-400 dark:text-gray-600 pr-8">
            ...
            <section className="py-24 px-6 md:px-10 lg:px-16">
              <div className="max-w-6xl mx-auto">
                ...
                <ScrollReveal direction="up" delay={0.3}>
                  <p className="text-gray-600 dark:text-gray-400 text-lg mb-16 max-w-2xl">
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-2">{projects[0].category}</p>
                          </div>
                          <span className="text-gray-600 dark:text-gray-400">{projects[0].year}</span>
                        </div>
                      </div>
                    </ScrollReveal>
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-2">{projects[2].category}</p>
                          </div>
                          <span className="text-gray-600 dark:text-gray-400">{projects[2].year}</span>
                        </div>
                      </div>
                    </ScrollReveal>
                  </div>
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-2">{projects[1].category}</p>
                          </div>
                          <span className="text-gray-600 dark:text-gray-400">{projects[1].year}</span>
                        </div>
                      </div>
                    </ScrollReveal>
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-2">{projects[3].category}</p>
                          </div>
                          <span className="text-gray-600 dark:text-gray-400">{projects[3].year}</span>
                        </div>
                      </div>
                    </ScrollReveal>
                  </div>
            ...
            {/* Footer */}
            <footer className="border-t border-gray-200 dark:border-gray-800 py-8 px-6 md:px-10 lg:px-16">
